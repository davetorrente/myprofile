                    ...
                    <div class="menu-container js_nav-item">
                        ...
                        <div class="logo">
                            <a class="logo-wrap" href="#body">
                                <img class="logo-img logo-img-main" src="{{URL::to('src/img/resumeLogo1.png')}}" alt="Asentus Logo">
                                <img class="logo-img logo-img-active" src="{{URL::to('src/img/resumeLogo1.png')}}" alt="Asentus Logo">
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
